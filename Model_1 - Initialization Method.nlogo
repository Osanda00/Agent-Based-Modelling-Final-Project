...
to setup
  ...
  ;; assigning initial idea 1 holders
  ask one-of turtles [
    become-idea1-holder
    ask link-neighbors [ become-idea1-holder ]
  ] ;; assigning initial idea 1 holders

  ;;assigning initial idea 2 holders
  ask one-of turtles with [Idea_State != 1] [
    become-idea2-holder
    ask link-neighbors [ become-idea2-holder ]
  ]
...
to spread-idea
  ...
  [ let proportion-idea1 0
    ...
    [
      ifelse (proportion-idea1 - threshold-idea1) > (proportion-idea2 - threshold-idea2) [ set next_Idea_state 1 ][set next_Idea_state 2]]
  ]
end
@#$#@#$#@
GRAPHICS-WINDOW
...
<experiments>
  <experiment name="experiment" repetitions="10" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="average-connection-per-person">
      <value value="49"/>
    </enumeratedValueSet>
